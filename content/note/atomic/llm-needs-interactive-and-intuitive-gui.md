---
title: "LLM needs interactive & intuitive GUI"
...
The Historical Pattern: From Command Line to GUI

Today's LLM Interface (talking to ChatGPT) is like using a 1980s command line
