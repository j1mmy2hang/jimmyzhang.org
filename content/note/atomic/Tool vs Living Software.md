...
Living software — constantly evolving, learning, adapting; do not have a defined-purpose; relationship with user is dynamic
...
I find Obsidian to be in an interesting position where it is at the same time a consistent and reliable tool and an evolving, adaptive, and dynamic parter (living software) of mine.

Which again amazes me how Obsidian is built to be a reliable tool in core with all the adaptive layers outside.