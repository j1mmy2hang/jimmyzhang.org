---
title: "Value of human = objective function & alignment layer"
...
> The point of human developers is to decide to pick an entirely different path and say, "Let's go try that instead," rather than just following the easiest path.
