---
title: "Hold belief & doubt at the same time"
...
容忍不确定性，意味着你要学会在 **“没有完美答案”** 的情况下继续推进。普通人遇到不确定性时，要么全盘接受现成规则（变成跟随者），要么陷入死胡同反复纠结（导致瘫痪）。而领导者（Leader）会在保持怀疑的同时，依然果断地采取行动。

作为一个想要独立做出伟大事业的人，你必须对自己的 Vision（愿景）抱有近乎狂妄的自信（“我是最好的，我做的事是最重要的”），否则你连第一步都迈不出去。但一旦进入执行层面，你又必须对自己做出的东西保持极度的怀疑和挑剔（“这东西肯定还有大问题”）。**在极度自信与极度自我怀疑之间游刃有余地切换，这就是容忍模糊性的本质。**
