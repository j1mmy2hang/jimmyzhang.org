...
**\2. Paradigms -- The mind-set out of which the system sets its goals, structure, rules, delays, parameters-arises**
...
we change paradigms by building a model of the system, which takes us outside the system and forces us to see it whole.
...
> Everyone who has managed to entertain that idea, for a moment or for a lifetime, has found it to be the basis for radical empowerment.