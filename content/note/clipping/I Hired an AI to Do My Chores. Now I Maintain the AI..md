...
Now, generalist AI tools like [Claude Cowork](https://every.to/vibe-check/vibe-check-claude-cowork-is-claude-code-for-the-rest-of-us) and specialist tools like [Sparkle](https://makeitsparkle.co/), Every’s AI file organizer, can do many of these tasks for you—and swiftly. They’re chores that [Claws](https://every.to/source-code/you-have-a-claw-now-what), or whatever forms personal AI agents take in the future, could do for you without your ongoing input.
...
“Maintenance is absolutely necessary *and* maintenance is optional,” says *Whole Earth Catalog* and Long Now Foundation founder **[Stewart Brand](https://sb.longnow.org/SB_homepage/Home.html)** in *[Maintenance: Of Everything, Part One](https://press.stripe.com/maintenance-part-one)*. Optional because we can put it off in the moment, necessary because putting it off for too long can lead to disaster.
...
Maintenance is virtuous. But it’s also rarely seen as heroic. If it were, maybe we wouldn’t be so bad at it. [Various explanations exist](https://themaintainers.org/why-do-people-neglect-maintenance/) for why we deprioritize maintenance, ranging from cultural values (we prize new invention over care for the existing), psychology and economics (we discount what isn’t immediately gratifying), and social class (we associate many maintenance jobs with minimum-wage work done by marginalized workers).
...
For over six years, journalist and author **[Chris Colin](https://www.chriscolin.com/)** has been hosting in-person gatherings akin to my digital ones. At these [“Admin Nights,”](https://www.wsj.com/lifestyle/relationships/how-to-turn-the-bureaucratic-grind-of-life-into-a-party-7205f690?st=N5CFwf&reflink=desktopwebshare_permalink) Colin and friends gather with their laptops to cancel streaming service subscriptions, file insurance pre-authorization forms, dispute erroneous credit card charges, and, more generally, try to pull themselves out of the morass of maddening tasks that swallow modern life.
...
So at a recent Digital Mending Circle, on the promise of a more frictionless life, I set up [OpenClaw](https://every.to/guides/claw-school). Or started to set up is more accurate. It took several hours beyond my allotted life maintenance session for me to get [my Claw, Pip](https://every.to/context-window/how-claws-took-over-every), working. Once Pip was up and running, I had it send my partner and me morning briefings of our day’s schedule and childcare duties, and prepare budget summaries that we could go over in our weekly household meeting—augmenting a system we already had in place to help us stay afloat.
