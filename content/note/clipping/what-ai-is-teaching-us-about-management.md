...
*In Mike Taylor’s work as an AI engineer, he’s found that many of the issues he encounters in using AI tools—such as their inconsistency, tendency to make things up, and lack of creativity—he used to struggle with when he ran a 50-person marketing agency. It’s all about giving AI models the right context to do the job, just like with humans. In the latest piece in his column [Also True for Humans](https://every.to/also-true-for-humans), about managing AIs like you’d manage people, Mike outlines the rise of New Taylorism, his thesis that management techniques for AIs and humans are converging, and that prompting belongs in the business school, not the computer science lab.— [Kate Lee](https://every.to/news/kate-lee-joins-every-as-editor-in-chief)*
...
The CTO of Moondream [captured this dynamic](https://x.com/vikhyatk/status/2002562431932072056) in a recent tweet:
...
Good management is a measurable economic advantage. The [World Management Survey](https://worldmanagementsurvey.org/), a decade-long research project by Stanford and London School of Economics economists, found that roughly a quarter of the 30 percent productivity gap that America has over Europe comes from differences in management quality alone. Now AI is democratizing access to that advantage. Anyone who works with AI is getting a crash course in management, whether they realize it or not.

I call this convergence of AI engineering and management practices “New Taylorism,” after **Frederick Winslow Taylor**, the mechanical engineer who pioneered [scientific management](https://www.ebsco.com/research-starters/business-and-management/taylorism) in the 1880s. He stood over factory workers with a stopwatch, timing their every movement, then redesigned their jobs into micro-tasks that could be measured, standardized, and optimized. But his attempts to make workflows even more efficient failed—because who likes to be a cog in a machine? His workers went on strike. AI, on the other hand, does not resent being asked to do the same task 50 times until you get it right.
...
**Zhengdong Wang**, asenior research engineer at Google DeepMind, received this advice from a consultant friend for [managing “hapless” new interns](https://zhengdongwang.com/2025/12/30/2025-letter.html): “You gotta treat them like they’re Perplexity Pro bots,” meaning give extremely clear instructions, don’t assume context, spell out exactly what you want, and check their work carefully. The same techniques that work for AI chatbots are now being applied to humans.

The [five principles of prompting I developed](https://www.oreilly.com/library/view/prompt-engineering-for/9781098153427/) work equally well as management techniques for humans:

1. **Give direction.***Describe the desired style in detail, or reference a relevant persona*. Whether you’re briefing Claude or a junior designer, “match the energy of Apple’s product pages—minimal, confident, lots of whitespace” is a much better instruction than “make it pop.”
2. **Specify format.***Define the rules and required structure of the response*. If you want bullet points on a deck, tell the AI.
3. **Provide examples.***Insert a diverse set of test cases where the task was done correctly*. Give the AI an example of a piece of content marketing, or series of tweets that worked well in the past.
4. **Evaluate quality.***Identify errors and rate responses, testing what drives performance.* Just like you give your team feedback, don’t publish AI output without a plan to measure outcomes.
5. **Divide labor.***Split complex goals into steps chained together*. This is exactly how you would approach a product launch—writing down all the steps that need to happen and tracking progress on each.
...
Prompting is a management skill that belongs in the business school, not the computer science department. And it’s only getting easier. The technical parts of prompt engineering are being automated away, and the latest models [can](https://every.to/also-true-for-humans/this-prompt-optimizer-learns-from-its-mistakes-like-dna) [rewrite prompts](https://every.to/also-true-for-humans/this-prompt-optimizer-learns-from-its-mistakes-like-dna) to get better performance on a task. All humans need to do is to decide what task to do, [define how it should be done](https://every.to/p/i-talked-to-more-than-100-companies-about-ai-here-s-what-s-actually-working), and collect or annotate a number of “good” examples of that task being done.
...
This is the second way in which AI teaches you management: [how to run a team](https://x.com/emollick/status/2007249835465072857?s=20).

Orchestration skills are, once again, not new—managers have been [vibe coding](https://www.reddit.com/r/programminghumor/comments/1nz16p4/managers_have_been_vibe_coding_forever/) forever. “Getting good results out of a coding agent feels uncomfortably close to getting good results out of a human collaborator,” [said](https://simonwillison.net/2025/Oct/7/vibe-engineering/) **[Simon Willison](https://simonwillison.net/2025/Oct/7/vibe-engineering/)**, co-creator of the Django framework.
...
The strategic frameworks business schools have taught for decades, such as **[Hamilton Helmer](https://tyastunggal.com/p/7-powers-the-foundations-of-business)** [‘s](https://tyastunggal.com/p/7-powers-the-foundations-of-business) *[7 Powers](https://tyastunggal.com/p/7-powers-the-foundations-of-business)* (which describes how companies can build lasting advantages through things like network effects) and **[Michael Porter](https://www.isc.hbs.edu/strategy/business-strategy/Pages/the-five-forces.aspx)** [‘s five forces](https://www.isc.hbs.edu/strategy/business-strategy/Pages/the-five-forces.aspx) (which maps competitive pressures across industries), are even more important because they’re the only source of differentiation left now that AI can write code.

**Alex Danco** of venture capital firm Andreessen Horowitz [recently wrote](https://www.a16z.news/p/why-ac-is-cheap-but-ac-repair-is) that as AI makes some parts of a job wildly more productive, the parts that can’t be automated become the bottleneck—and therefore the reason you get paid. The judgment calls, the problem-solving, and the strategic bets commands a premium.
...
Where AI falls apart is the tactical thinking in between. I call this the [NCO gap](https://www.saxifrage.xyz/post/nco-gap), borrowing from military structure. Officers set strategy from headquarters, and enlisted soldiers execute orders on the ground. The sergeants who bridge that gap are non-commissioned officers. They understand command intent *and* ground truth, and translate strategy into action under conditions of uncertainty.

Every’s **[Dan Shipper](https://every.to/@danshipper)** has written about how humans are shifting from makers to “ [model managers](https://every.to/chain-of-thought/the-knowledge-economy-is-over-welcome-to-the-allocation-economy) “ as AI handles more execution. I’d push this further: We’re middle managers, the NCOs of today.
...
[![As opposed to AI, humans thrive in the messy middle between tactics and strategy. (Courtesy of Mike Taylor and Every.)](https://d24ovhgu8s7341.cloudfront.net/uploads/editor/posts/3899/optimized_a8420929-20cb-45db-990f-8ac4cb89a642.png)](https://d24ovhgu8s7341.cloudfront.net/uploads/editor/posts/3899/optimized_a8420929-20cb-45db-990f-8ac4cb89a642.png)

As opposed to AI, humans thrive in the messy middle between tactics and strategy. (Courtesy of Mike Taylor and Every.)


Researchers saw this play out when they had [Claude play Pokémon](https://news.ycombinator.com/item?id=43173825). Claude understood the overall objective—to become champion—and could execute individual moves with precision. But it got stuck in the first cave of the game, Mt. Moon, for over 48 hours. The solution required maybe seven moves, something I navigated when I was 12 years old. Claude knew where it was going and could execute any command perfectly, but it couldn’t figure out the medium-level tactics to translate movement into progress when it got stuck in Pokémon.
