...
Cards on the table - I think AI is going to have an impact about on-par with the internet, or railroads, but that we’re also definitely in a bubble. I wrote about this in [*What’s next after the AI bubble bursts?*](https://www.seangoedecke.com/after-the-ai-bubble). **I am not convinced that the NANDA report is bad news for AI**.
...
Also, to state the obvious, **AI is a brand-new technology.** Most failed enterprise IT projects are effectively “solved problems”: like migrating information into a central database, or tracking high-volume events, or aggregating various data sources into a single data warehouse for analysis. Of course, any software engineer should know that solving a “solved problem” is not easy. The difficulties are in all the myriad details that have to be worked out.
...
![nanda](https://www.seangoedecke.com/static/88f2c237b5247d1e799db431244b9daf/fcda8/nanda.png "nanda")
