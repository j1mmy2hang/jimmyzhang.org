...
In 2023, 12 years after reading *The* *4-Hour Work Week*, I was making enough passive income from my [Udemy course on prompt engineering](https://www.udemy.com/course/prompt-engineering-for-ai/?referralCode=2CB7EC23BE3A5C15AB80) to achieve the **Tim Ferriss** dream.

I didn’t need a job. Yet I decided to trade freedom for a monthly paycheck again when I joined Every in February full-time to lead [tech consulting](https://every.to/on-every/the-next-chapter-of-every-consulting) and [write](https://every.to/also-true-for-humans).

My friends are puzzled. Isn’t the course making more money than ever ([despite what the prompt engineering haters](https://spectrum.ieee.org/prompt-engineering-is-dead) say)? What will it be like having a boss after five years of self-employment and six years building a company before that? Don’t you remember vowing to [never take another job](https://medium.com/@2michaeltaylor/fired-for-the-last-time-9533db90861c)?
...
It wasn’t just the course. Almost all the work I did as an entrepreneur started with months of unpaid work. I worked for two months without a paycheck when I started my [marketing agency](https://ladder.io/), and only started paying myself six figures when we scaled past 30 people. I worked for three months for free on a data science project as a learning exercise before turning that into a seven-figure [consulting practice](https://www.lennysnewsletter.com/p/how-todays-top-consumer-brands-measure). I spent a year writing a [prompt engineering book](https://learning.oreilly.com/library/view/prompt-engineering-for/9781098153427/) for O’Reilly before I saw my first royalty check.
...
Friends who run startups report similar low batting averages, and most successful entrepreneurs have [many more failures](https://x.com/levelsio/status/1457315274466594817) than they do wins. ==The hardest thing to cope with, however, is the uncertainty.==
...
I heard Dan give a non-obvious insight on “claw-human” psychology on a call, and when I asked him about it later, he [directed me to a tweet](https://x.com/danshipper/status/2026014755438182782) he had written I hadn’t seen. I have already cited his insight in two different client meetings. As a follower on X, I might have seen his take eventually, but as an employee, I got to ask my own questions about it. Outside the company, I would have eventually figured this insight out, but inside, I get to help shape it. It’s like the difference between passively watching a movie and actively playing a video game.

I don’t think I’m the only one making this calculation—giving up freedom and self-employment to work with a team on AI.

Investor and author **Byrne Hobart** [joked](https://x.com/ByrneHobart/status/2026048219407376733?s=20) that job offers at Anthropic come with a negative $10 million salary—you have to pay to work there—in return for getting to read their upcoming blog posts and tweets 24 hours in advance. That information is worth gold, given how much the [market moves](https://www.businessinsider.com/claude-ai-tools-tech-selloff-software-apocalypse-cybersecurity-anthropic-ibm-2026-2) when the company publishes something new. He’s kidding, but the underlying logic is real: ==Proximity to the frontier is so valuable that it changes what the math on a “good deal” looks like.==

[![Investor and author Byrne Hobart has joked about the potential benefits of joining an AI lab. (Screenshot courtesy of Every.)](https://d24ovhgu8s7341.cloudfront.net/uploads/editor/posts/4016/optimized_852e101e-fb5c-45ff-bbad-59c07bb5d7c4.png)](https://d24ovhgu8s7341.cloudfront.net/uploads/editor/posts/4016/optimized_852e101e-fb5c-45ff-bbad-59c07bb5d7c4.png)

Investor and author Byrne Hobart has joked about the potential benefits of joining an AI lab. (Screenshot courtesy of Every.)

### Sharing the cool stuff

The narrative at the moment is that AI is leading to [new business formation](https://www.commerceinstitute.com/new-businesses-started-every-year/) and acts as a great [equalizer for small businesses](https://www.business.com/articles/ai-usage-smb-workplace-study/). There’s even talk of the [first billion-dollar one-person company](https://every.to/napkin-math/the-one-person-billion-dollar-company). I believe those milestones will be achieved, yet I don’t want to be the person who builds it.
