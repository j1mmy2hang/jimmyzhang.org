---
title: "Theory of Constraints -- System Performance Hinges on its Core Constraint"
...
*   **Critical Path Method (CPM):** Used in project management. CPM identifies the longest sequence of *tasks*. TOC's [[critical-chain-project-management-managing-uncertainty-and-resources|Critical Chain Project Management (CCPM)]] extends this by explicitly considering *resource* constraints (people, equipment) and managing uncertainty via project/feeding buffers, not task-level padding.
