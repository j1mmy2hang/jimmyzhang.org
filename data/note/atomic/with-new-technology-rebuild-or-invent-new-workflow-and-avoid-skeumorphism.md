---
title: "With new technology, rebuild or invent new workflow and avoid skeumorphism"

created: 2025-12-09 13:12
reference:
...
**The trap:** Using new technology to just copy old forms, instead of exploring what the new technology uniquely enables.

**Skeuomorphic AI apps** = Taking existing workflows and just adding AI to them.

[[vertical-ai-that-only-wraps-base-model-capabilities-has-no-future]]

Base models will get good enough to do these tasks directly. Your "specialized" wrapper adds no lasting value.
...
similar:: [[new-technology-doesnt-improve-old-systems-it-makes-them-obsolete]]

---

## Build companies that could not have existed without AI
